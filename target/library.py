...
class GettextBaseTarget(base.ConfigureMakeStaticDependencyTarget):
    def prepare_source(self, state: BuildState):
        state.download_source(
...
class IntlTarget(GettextBaseTarget):
    def __init__(self):
        super().__init__('intl')
...
class Mpg123Target(base.CMakeStaticDependencyTarget):
    ...
    def prepare_source(self, state: BuildState):
        state.download_source(
            'https://www.mpg123.de/download/mpg123-1.33.1.tar.bz2',
...
class ZMusicTarget(base.CMakeStaticDependencyTarget):
    def __init__(self):
        super().__init__('zmusic')

    def prepare_source(self, state: BuildState):
        state.download_source(
            'https://github.com/ZDoom/ZMusic/archive/refs/tags/1.2.0.tar.gz',
            'fc8419a5fa80faa2363a57711e4ec4670b3628aecf1dc9b4306f4add0ce09d2b')
