...
class FobosTarget(base.CMakeDependencyTarget):
    # Depends on usb
    ...
    def prepare_source(self, state: BuildState):
        state.download_source(
            'https://github.com/alexey-lysiuk/libfobos/archive/refs/tags/v.2.3.2-fixed.tar.gz',
            '7f1ba1ab3fbd08466aac47808918a5508a1d3df8f6753b95aa496dbab950c5fe'
        )
