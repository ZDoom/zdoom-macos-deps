...
class FluidSynthTarget(base.CMakeStaticDependencyTarget):
    ...
    def prepare_source(self, state: BuildState):
        state.download_source(
            'https://github.com/FluidSynth/fluidsynth/archive/refs/tags/v2.4.3.tar.gz',
            'a92aa83d2ff09a1a6d6186e81d8182bd2958947dffca77a6490ffd41b3ec9dc7',
...
class Sdl2ImageTarget(base.CMakeStaticDependencyTarget):
    ...
    def prepare_source(self, state: BuildState):
        state.download_source(
            ...
            '8bc4c57f41e2c0db7f9b749b253ef6cecdc6f0b689ecbe36ee97b50115fff645')
...
class ZlibNgTarget(base.CMakeStaticDependencyTarget):
    ...
    def prepare_source(self, state: BuildState):
        state.download_source(
            'https://github.com/zlib-ng/zlib-ng/archive/refs/tags/2.2.3.tar.gz',
            'f2fb245c35082fe9ea7a22b332730f63cf1d42f04d84fe48294207d033cba4dd')
